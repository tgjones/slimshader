...
dcl_output o0.xyzw
dcl_temps 9
sample_l_aoffimmi(0,-1,0) r0.xyzw, v1.xyxx, t0.xyzw, s3, l(0.000000)
sample_l_aoffimmi(-1,0,0) r1.xyzw, v1.xyxx, t0.xyzw, s3, l(0.000000)
sample_l_aoffimmi(0,0,0) r2.xyzw, v1.xyxx, t0.xyzw, s3, l(0.000000)
sample_l_aoffimmi(1,0,0) r3.xyzw, v1.xyxx, t0.xyzw, s3, l(0.000000)
sample_l_aoffimmi(0,1,0) r4.xyzw, v1.xyxx, t0.xyzw, s3, l(0.000000)
...
if_nz r5.y
  ...
  sample_l_aoffimmi(-1,-1,0) r5.xyzw, v1.xyxx, t0.xyzw, s3, l(0.000000)
  sample_l_aoffimmi(1,-1,0) r6.xyzw, v1.xyxx, t0.xyzw, s3, l(0.000000)
  sample_l_aoffimmi(-1,1,0) r7.xyzw, v1.xyxx, t0.xyzw, s3, l(0.000000)
  sample_l_aoffimmi(1,1,0) r8.xyzw, v1.xyxx, t0.xyzw, s3, l(0.000000)
  add r3.xyz, r5.xyzx, r6.xyzx
  add r3.xyz, r7.xyzx, r3.xyzx
  add r3.xyz, r8.xyzx, r3.xyzx
  add r0.xyz, r0.xyzx, r3.xyzx
  mul r0.xyz, r1.xxxx, r0.xyzx
  mad r1.y, r5.y, l(1.963211), r5.x
  mad r1.z, r6.y, l(1.963211), r6.x
  mad r3.x, r7.y, l(1.963211), r7.x
  mad r3.y, r8.y, l(1.963211), r8.x
  ...
  loop 
    ...
    breakc_nz r6.w
    if_z r6.x
      sample_l r7.xyzw, r4.zwzz, t0.xyzw, s3, l(0.000000)
      mad r6.w, r7.y, l(1.963211), r7.x
    else 
      mov r6.w, r5.z
    endif 
    if_z r6.y
      sample_l r7.xyzw, r5.xyxx, t0.xyzw, s3, l(0.000000)
  ...
  and r0.w, r0.w, r1.y
  add r3.y, r0.w, v1.y
  sample_l r3.xyzw, r3.xyxx, t0.xyzw, s3, l(0.000000)
  mad r0.xyz, r0.xyzx, l(0.111111, 0.111111, 0.111111, 0.000000), r3.xyzx
  mad r2.xyz, -r1.xxxx, r3.xyzx, r0.xyzx
endif 
mov o0.xyz, r2.xyzx
mov o0.w, l(1.000000)
ret 
