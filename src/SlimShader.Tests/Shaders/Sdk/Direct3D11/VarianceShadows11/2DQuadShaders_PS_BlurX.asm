...
mov r0.xy, v1.xyxx
mov r0.z, l(0)
sample_aoffimmi_indexable(-1,0,0)(texture2darray)(float,float,float,float) r1.xy, r0.xyzx, t5.xyzw, s5
sample_aoffimmi_indexable(0,0,0)(texture2darray)(float,float,float,float) r1.zw, r0.xyzx, t5.zwxy, s5
sample_aoffimmi_indexable(1,0,0)(texture2darray)(float,float,float,float) r0.xy, r0.xyzx, t5.xyzw, s5
